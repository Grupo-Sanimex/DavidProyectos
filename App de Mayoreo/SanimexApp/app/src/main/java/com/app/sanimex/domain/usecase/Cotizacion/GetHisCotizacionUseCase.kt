...
class GetHisCotizacionUseCase@Inject constructor(
    private val networkRepository: NetworkRepository
    ) {
    suspend operator fun invoke(fecha: String): Flow<Resource<List<HisCotizacionM>>>{
        return networkRepository.getHisCotizacion(fecha)
    }
}
